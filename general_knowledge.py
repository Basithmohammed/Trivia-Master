...
print("""
        ...
        <div class="main">
            ...
            <form method="post" action="#" class="options">
                ...
                <input type="submit" name="sub1" class="div1" id="opt2" value="%s"onclick="changeColor2()"></div>
            ...
            <a href="gk2.py?id=%s" class="next round">&#8250;</a>
...
if psub != None:
    ...
    print("""
        ...
        """ % (id))
w = """update users set score=%s where sno=%s""" % (user_score, id)
cur.execute(w)
connection.commit()
# print(user_score)
...
# score_board = f.getvalue("sub1")
#
# if score_board != None:
#     q = """UPDATE users SET uanswer= '%s' WHERE sno= '%s' """% (score_board, id)
#     cur.execute(q)
#
#
#     # a="""select answer from gk where sno=1"""
#     # b="""select uanswer from users where sno=%s"""%(id)
#     # print(a,b)
#     print("""
#         <script>
#             alert("Success!!");
